		...
		<ul class="wonderplugin-tabs" id="wonderplugin-carousel-tabs">
			<li class="wonderplugin-tab wonderplugin-tab-selected">	
				...
				<div class="wonderplugin-toolbar">	
					...
					<label style="float:right;"><input type="button" class="button" id="wonderplugin-reverselist" value="<?php _e( 'Reverse List', 'wonderplugin_carousel' ); ?>" /></label>
					...
					<div class="wonderplugin-carousel-options-tabs" id="wonderplugin-carousel-options-tabs">
						...
						<ul class="wonderplugin-tabs-horizontal" id="wonderplugin-lightbox-panels">
							...
							<tr valign="top">
								...
								<td><label for="wonderplugin-carousel-lightboxshowsocial"><input name="wonderplugin-carousel-lightboxshowsocial" type="checkbox" id="wonderplugin-carousel-lightboxshowsocial" /> Enable social media</label>
								<p><label for="wonderplugin-carousel-lightboxshowfacebook"><input name="wonderplugin-carousel-lightboxshowfacebook" type="checkbox" id="wonderplugin-carousel-lightboxshowfacebook" /> Show Facebook button</label>
								<br><label for="wonderplugin-carousel-lightboxshowtwitter"><input name="wonderplugin-carousel-lightboxshowtwitter" type="checkbox" id="wonderplugin-carousel-lightboxshowtwitter" /> Show Twitter button</label>
								<br><label for="wonderplugin-carousel-lightboxshowpinterest"><input name="wonderplugin-carousel-lightboxshowpinterest" type="checkbox" id="wonderplugin-carousel-lightboxshowpinterest" /> Show Pinterest button</label></p>
								</td>
							</tr>
