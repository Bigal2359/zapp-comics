    ...
    <div class="box1">
    	...
    	<div class="store-locations main-site">
    		<ul>
    			...
    			<li><a href="#store-footer" class="manalapan scroll-btn">MANALAPAN</a></li>
    		</ul>
    	</div>
    ...
    <div class="box2">
    	...
    	<div class="span5 info_box main-site">
            ...
            <div class="box wayne-info">
        		...
        		<p>Also in <a class="manalapan scroll-btn" href="#store-footer">Manalapan, NJ</a></p>
            </div>
    	    <div class="box manalapan-info">
        		...
        		<p>Also in <a class="wayne scroll-btn" href="#store-footer">Wayne, NJ</a></p>
            </div>
    	</div>
...
<div class="scroll-nav comic-con">
    <ul>
        <li>
            <a class="scroll-btn" href="#about-section">About</a>
        </li>
        <li>
            <a class="scroll-btn" href="#artists-section">Artists</a>
        </li>
        <li>
            <a class="scroll-btn" href="#events-section">Events</a>
        </li>
        <li>
            <a class="scroll-btn" href="#store-footer">Badges</a>
        </li>
    </ul>
</div>