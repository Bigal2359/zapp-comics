...
// Fonts
            ...
            $typography_mixed_fonts["Noto Sans"] = "Noto Sans *";
...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '12px', 'lineheight' => '24px', 'face' => 'Noto Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#777777'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '21px', 'lineheight' => '24px', 'face' => 'Noto Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#2f2f2f'));
			...
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '27px', 'face' => 'Noto Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#d45112'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Noto Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Noto Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#333333'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '111px', 'lineheight' => '111px', 'face' => 'Noto Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#f19028'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '21px', 'lineheight' => '21px', 'face' => 'Noto Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Noto Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#0088CC'));

			$options['foo'] = array( "name" => "foo",
								"type" => "heading");

			$options['live_chat_id'] = array( "id" => "live_chat_id",
